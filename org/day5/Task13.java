...
public class Task13 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement mouseSec = driver.findElement(By.xpath("(//a[text()='Paint'])[1]"));
		act.moveToElement(mouseSec).perform();
		
		WebElement mouseth = driver.findElement(By.xpath("//a[text()='Interior Paint']"));
		act.moveToElement(mouseth).perform();
		
		
		WebElement mouClick = driver.findElement(By.xpath("//a[text()='Ceiling Paint']"));
		Thread.sleep(3000);
		mouClick.click();
		driver.quit();
	}
